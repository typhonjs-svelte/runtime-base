 ...
 *
 * @property {BaseArrayObjectEntryStore} StoreClass The entry store class that is instantiated.
 *
 ...
 *
 * @property {boolean}        [manualUpdate=false] When true `ArrayObjectStore.updateSubscribers` must be invoked
