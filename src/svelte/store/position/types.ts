...
import type { PositionStateAPI }    from './state/types';

import type { System }              from './system/types';

import type { TransformAPI }        from './transform/types';

export declare namespace TJSPositionNS {
   export { Action };
   ...
   export namespace Options {
      ...
      export type Config = {
          ...
          */
         initial: TJSPositionNS.System.Initial.InitialSystem;
       ...
       */
      export type ConfigAll = Partial<Config & TJSPositionNS.Data.TJSPositionDataExtra>;
      ...
      export type Get = {
          ...
          */
         keys?: Iterable<keyof TJSPositionNS.Data.TJSPositionData>;

         /**
          * When provided these keys are excluded.
          */
         exclude?: Iterable<keyof TJSPositionNS.Data.TJSPositionData>;
