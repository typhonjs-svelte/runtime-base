 ...
 */
interface GunzipStreamOptions extends InflateStreamOptions {}
/**
 ...
 */
interface UnzlibStreamOptions extends InflateStreamOptions {}
/**
 ...
 */
interface AsyncDeflateOptions extends DeflateOptions, AsyncOptions {}
/**
 ...
 */
interface AsyncGzipOptions extends GzipOptions, AsyncOptions {}
/**
 * Options for decompressing GZIP data asynchronously
 */
interface AsyncGunzipOptions extends AsyncOptions, InflateStreamOptions {}
/**
 * Options for compressing data asynchronously into a Zlib format
 */
interface AsyncZlibOptions extends ZlibOptions, AsyncOptions {}
/**
 * Options for decompressing Zlib data asynchronously
 */
interface AsyncUnzlibOptions extends AsyncInflateOptions {}
/**
 ...
 */
declare function deflate(data: Uint8Array, opts: AsyncDeflateOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously compresses data with DEFLATE without any wrapper
 * @param data The data to compress
 * @param cb The function to be called upon compression completion
 */
declare function deflate(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 ...
 */
declare function inflate(data: Uint8Array, opts: AsyncInflateOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously expands DEFLATE data with no wrapper
 * @param data The data to decompress
 * @param cb The function to be called upon decompression completion
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function inflate(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 ...
 * @returns A function that can be used to immediately terminate the compression
 */
declare function gzip(data: Uint8Array, opts: AsyncGzipOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously compresses data with GZIP
 * @param data The data to compress
 * @param cb The function to be called upon compression completion
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function gzip(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 ...
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function gunzip(data: Uint8Array, opts: AsyncGunzipOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously expands GZIP data
 * @param data The data to decompress
 * @param cb The function to be called upon decompression completion
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function gunzip(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 * Expands GZIP data
 * @param data The data to decompress
 * @param opts The decompression options
 ...
 * @param cb The function to be called upon compression completion
 */
declare function zlib(data: Uint8Array, opts: AsyncZlibOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously compresses data with Zlib
 * @param data The data to compress
 * @param cb The function to be called upon compression completion
 * @returns A function that can be used to immediately terminate the compression
 */
declare function zlib(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 ...
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function unzlib(data: Uint8Array, opts: AsyncUnzlibOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously expands Zlib data
 * @param data The data to decompress
 * @param cb The function to be called upon decompression completion
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function unzlib(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 * Expands Zlib data
 * @param data The data to decompress
 * @param opts The decompression options
 ...
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function decompress(data: Uint8Array, opts: AsyncInflateOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchrononously expands compressed GZIP, Zlib, or raw DEFLATE data, automatically detecting the format
 * @param data The data to decompress
 * @param cb The function to be called upon decompression completion
 * @returns A function that can be used to immediately terminate the decompression
 */
declare function decompress(data: Uint8Array, cb: FlateCallback): AsyncTerminable;
/**
 ...
 */
interface AsyncZipOptions extends AsyncDeflateOptions, ZipAttributes {}
/**
 * Options for asynchronously expanding a ZIP archive
 */
interface AsyncUnzipOptions extends UnzipOptions {}
/**
 ...
 */
declare function strFromU8(dat: Uint8Array, latin1?: boolean): string;
/**
 ...
 */
declare class ZipPassThrough implements ZipInputFile {
  filename: string;
  crc: number;
  size: number;
  compression: number;
 ...
 */
declare class ZipDeflate implements ZipInputFile {
  filename: string;
  crc: number;
  size: number;
  compression: number;
 ...
 */
declare class AsyncZipDeflate implements ZipInputFile {
  filename: string;
  crc: number;
  size: number;
  compression: number;
 ...
 * @returns A function that can be used to immediately terminate the compression
 */
declare function zip(data: AsyncZippable, opts: AsyncZipOptions, cb: FlateCallback): AsyncTerminable;
/**
 * Asynchronously creates a ZIP file
 * @param data The directory structure for the ZIP archive
 * @param cb The callback to call with the generated ZIP archive
 * @returns A function that can be used to immediately terminate the compression
 */
declare function zip(data: AsyncZippable, cb: FlateCallback): AsyncTerminable;
/**
 ...
 * better performance.
 */
declare class UnzipInflate implements UnzipDecoder {
  static compression: number;
  private i;
  ondata: AsyncFlateStreamHandler;
  /**
 ...
 */
declare class AsyncUnzipInflate implements UnzipDecoder {
  static compression: number;
  private i;
  ondata: AsyncFlateStreamHandler;
  terminate: AsyncTerminable;
 ...
 */
declare function unzip(data: Uint8Array, opts: AsyncUnzipOptions, cb: UnzipCallback): AsyncTerminable;
/**
 * Asynchronously decompresses a ZIP archive
 * @param data The raw compressed ZIP file
 * @param cb The callback to call with the decompressed files
 * @returns A function that can be used to immediately terminate the unzipping
 */
declare function unzip(data: Uint8Array, cb: UnzipCallback): AsyncTerminable;
/**
...
export {
  ...
  AsyncDecompress,
  AsyncDeflate,
  type AsyncDeflateOptions,
  type AsyncFlateDrainHandler,
  type AsyncFlateStreamHandler,
  AsyncGunzip,
  type AsyncGunzipOptions,
  AsyncGzip,
  type AsyncGzipOptions,
  AsyncInflate,
  type AsyncInflateOptions,
  ...
  type FlateError,
  FlateErrorCode,
  type FlateStreamHandler,
  Gunzip,
  type GunzipMemberHandler,
  type GunzipOptions,
  type GunzipStreamOptions,
  Gzip,
  type GzipOptions,
  Inflate,
  type InflateOptions,
  type InflateStreamOptions,
  type StringStreamHandler,
  Unzip,
  type UnzipCallback,
  type UnzipDecoder,
