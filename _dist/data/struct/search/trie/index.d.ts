 ...
 */
type TrieSearchSubscribeHandler<T extends object> = ({
  action,
  trieSearch,
}: {
 ...
 * @template T
 */
declare class UnionReducer<T extends object> implements TrieSearchReducer<T> {
  #private;
...
export {
  ...
  TrieSearch,
  type TrieSearchOptions,
  type TrieSearchReducer,
  type TrieSearchReducerData,
  type TrieSearchReducerResetData,
  type TrieSearchSubscribeHandler,
  UnionReducer,
};
