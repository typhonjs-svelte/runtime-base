 ...
 * of 6 numbers.
 */
type Mat2dLike = [number, number, number, number, number, number] | Float32Array;
/**
 * A 2x3 Matrix
 */
 ...
 */
type Vec4Like = [number, number, number, number] | Float32Array;
/**
 ...
 */
type Vec3Like = [number, number, number] | Float32Array;
/**
 ...
 */
type Quat2Like = [number, number, number, number, number, number, number, number] | Float32Array;
/**
 * Dual Quaternion
 */
 ...
 * of 9 numbers.
 */
type Mat3Like = [number, number, number, number, number, number, number, number, number] | Float32Array;
/**
 * A 3x3 Matrix
 */
 ...
 */
type Vec2Like = [number, number] | Float32Array;
/**
 ...
 * of 4 numbers.
 */
type Mat2Like = [number, number, number, number] | Float32Array;
/**
 * A 2x2 Matrix
 */
declare class Mat2 extends Float32Array {
  ...
  static LDU(
    ...
    U: Mat2Like,
    a: Readonly<Mat2Like>,
  ): (readonly [number, number, number, number] | Readonly<Float32Array>)[];
  /**
