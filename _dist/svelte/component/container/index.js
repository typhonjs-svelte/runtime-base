 ...
 * presses.
 *
 * @property {import('@typhonjs-svelte/runtime-base/svelte/action/dom/style').PadToVisualEdgeSides} [padToVisualEdge=false] When true, the
 ...
 * content space.
 *
 * @property {import('@typhonjs-svelte/runtime-base/svelte/store/util').MinimalWritable<number>} [scrollLeft] A Svelte store that serializes
 * the scroll left position of the scrollable container.
 *
 * @property {import('@typhonjs-svelte/runtime-base/svelte/store/util').MinimalWritable<number>} [scrollTop] A Svelte store that serializes
 ...
 *
 * @property {import('@typhonjs-svelte/runtime-base/svelte/util').TJSSvelte.Config.Embed} [svelte] A svelte component configuration object
