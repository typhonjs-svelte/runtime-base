...
declare namespace TJSGlassPane {
  ...
  export type Props = {
    ...
    inTransitionOptions?: {} | undefined;
    outTransitionOptions?: {} | undefined;
  };
...
type TJSScrollContainerData = {
   ...
   */
  attach?: svelte_action.Action<HTMLElement, undefined, any> | undefined;
  /**
   ...
   */
  keyPropagate?: boolean | undefined;
  /**
   ...
   */
  gutterStable?: boolean | undefined;
  /**
   * Callback to handle context menu
   * presses.
   */
  onContextMenu?: ((data: { event: KeyboardEvent | PointerEvent }) => void) | undefined;
  /**
   * When true, the
   ...
   */
  padToVisualEdge?: _typhonjs_svelte_runtime_base_svelte_action_dom_style.VisualEdgeSides | undefined;
  /**
   * A Svelte store that serializes
   * the scroll left position of the scrollable container.
   */
  scrollLeft?: _typhonjs_svelte_runtime_base_svelte_store_util.MinimalWritable<number> | undefined;
  /**
   * A Svelte store that serializes
   * the scroll top position of the scrollable container.
   */
  scrollTop?: _typhonjs_svelte_runtime_base_svelte_store_util.MinimalWritable<number> | undefined;
  /**
   ...
   */
  svelte?:
    | _typhonjs_svelte_runtime_base_svelte_util.TJSSvelte.Config.Embed<
