...
class StyleMetric {
    ...
    static #arrayExpand4_1 = Object.seal(['0', '0', '0', '0']);
    /** Used in {@link StyleMetric.getVisualEdgeInsets} */
    static #arrayExpand4_2 = Object.seal(['0', '0', '0', '0']);
    /** The cached scrollbar width calculation from {@link StyleMetric.getScrollbarWidth}. */
    static #cachedScrollbarWidth = void 0;
     ...
     *   // → ['10px','20px','30px','20px']
     */
    static expand4Length(tokens, { defaultValue = '0', output = new Array(4) } = {}) {
        if (!Array.isArray(tokens)) {
            throw new TypeError(`'tokens' is not an array.`);
        }
        if (!Array.isArray(output)) {
            throw new TypeError(`'output' is not an array.`);
        }
        if (typeof defaultValue !== 'string') {
            throw new TypeError(`'defaultValue' is not a string.`);
        }
     ...
     */
    static getVisualEdgeInsets(el, output, { computedStyle, offsetHeight, offsetWidth } = {}) {
        ...
        const tokensWidth = this.expand4Length(computedStyle.borderImageWidth.trim().split(this.#regexWhiteSpace), { output: this.#arrayExpand4_1 });
        const tokensSlice = this.expand4Length(computedStyle.borderImageSlice.trim().split(this.#regexWhiteSpace), { output: this.#arrayExpand4_2 });
     ...
     */
    static getScrollbarWidth({ cached = true } = {}) {
        if (typeof cached !== 'boolean') {
            throw new TypeError(`'cached' is not a boolean.`);
        }
        // Return any cached value.
        if (cached && typeof this.#cachedScrollbarWidth === 'number') {
        ...
        if (typeof this.#cachedScrollbarWidth !== 'number') {
            this.#cachedScrollbarWidth = scrollbarWidth;
        }
     ...
     */
    static #resolveBorderWidth(value, borderWidth, ref) {
