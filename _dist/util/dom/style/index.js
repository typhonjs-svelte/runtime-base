...
class StyleMetric {
     ...
     */
    static getPaintedBorderWidth(el, output, { computedStyle, offsetHeight, offsetWidth } = {}) {
        if (!computedStyle) {
        ...
        const tokensWidth = this.#expand4(computedStyle.borderImageWidth.trim().split(this.#regexWhiteSpace), this.#arrayExpand4_1);
        const tokensSlice = this.#expand4(computedStyle.borderImageSlice.trim().split(this.#regexWhiteSpace), this.#arrayExpand4_2);
