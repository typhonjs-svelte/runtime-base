...
declare class PluginEntry {
  ...
  constructor(
    ...
    data: PluginData,
    instance: object,
    eventbusProxy?: _runtime_plugin_manager_eventbus.EventbusProxy,
  );
  /**
   * Get plugin data.
   *
...
declare interface PluginSupportImpl {
   ...
   */
  destroy({ eventbus, eventPrepend }: { eventbus: Eventbus; eventPrepend: string }): Promise<void>;
  /**
...
declare class PluginManager {
   ...
   *                                                plugins.
   */
  getEnabled({ plugins }?: { plugins?: string | Iterable<string> }): boolean | DataOutPluginEnabled[];
  /**
   ...
   */
  getPluginByEvent({ event }: { event: string | RegExp }): string[] | DataOutPluginEvents[];
  /**
   ...
   */
  getPluginData({ plugins }?: { plugins?: string | Iterable<string> }): PluginData | PluginData[] | undefined;
  /**
   ...
   */
  getPluginEvents({ plugins }?: { plugins?: string | Iterable<string> }): DataOutPluginEvents[];
  /**
   ...
   */
  getPluginNames({ enabled }?: { enabled?: boolean }): string[];
  /**
   ...
   */
  hasPlugins({ plugins }?: { plugins?: string | Iterable<string> }): boolean;
  /**
   ...
   */
  reload({ plugin, instance, silent }: { plugin: string; instance?: object; silent?: boolean }): Promise<boolean>;
  /**
   ...
   * @returns {Promise<import('.').DataOutPluginRemoved[]>} A list of plugin names and removal success state.
   */
  remove({ plugins }: { plugins: string | Iterable<string> }): Promise<DataOutPluginRemoved[]>;
  /**
   ...
   */
  setEnabled({ enabled, plugins }: { enabled: boolean; plugins?: string | Iterable<string> }): void;
  /**
   * Sets the eventbus associated with this plugin manager. If any previous eventbus was associated all plugin manager
   * events will be removed then added to the new eventbus. If there are any existing plugins being managed their
   * events will be removed from the old eventbus and then `onPluginLoad` will be called with the new eventbus.
...
declare class PluginInvokeSupport implements PluginSupportImpl {
   ...
   */
  getMethodNames({ enabled, plugins }?: { enabled?: boolean; plugins?: string | Iterable<string> }): string[];
  /**
   ...
   */
  hasMethod({ method, plugins }: { method: string; plugins?: string | Iterable<string> }): boolean;
  /**
   ...
   */
  invoke({ method, args, plugins }: { method: string; args?: any[]; plugins?: string | Iterable<string> }): void;
  /**
